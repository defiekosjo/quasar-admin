  ...
  <q-layout view="lHh Lpr lFf">
    <q-header elevated>
      <q-toolbar>
        <q-btn
          ...
          aria-label="Menu"
        />
        <q-toolbar-title> Gibas Ecosystem </q-toolbar-title>
        <q-space />
        <div class="q-gutter-sm row items-center no-wrap">
          ...
          />
          <!-- code of line to setup dark mode -->
    ...
    >
      <q-scroll-area style="height: 100%; max-width: 100%">
        <q-list>
          <img
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQr1XdHERcHd2OyUVkB2T3FQ93cUycrUFT-eg&usqp=CAU"
            style="width: 100%"
          />
          ...
          <q-expansion-item icon="pages" label="User Settings">
